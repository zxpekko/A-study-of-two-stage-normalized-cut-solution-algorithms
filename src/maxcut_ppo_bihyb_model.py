...
class ActorNet(torch.nn.Module):
    def __init__(
        ...
        #print('self.act1_resnet',self.act1_resnet)
    ...
    def _get_mask1(self, batch_size, num_nodes, edge_candidates):
        ...
        for b in range(batch_size):
            ready_nodes.append([])
            # print(edge_candidates[b])
            # print(type(edge_candidates[b]))
    ...
    def _get_mask2(self, batch_size, num_nodes, edge_candidates, act1):
        ...
        for b in range(batch_size):
            ready_nodes.append([])
            #print('act1[b].item() ',act1[b].item())
            candidates = edge_candidates[b][act1[b].item()]
            # u, v = edge_candidates[b][act1[b].item()]
            # candidates = {u,v}
...
if __name__ == '__main__':
    g = GraphEncoder(10,10,batch_norm=False,one_hot_degree=0)
    print(g)
